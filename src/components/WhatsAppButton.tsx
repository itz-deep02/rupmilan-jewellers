...
const WHATSAPP_URL =
  "https://api.whatsapp.com/send/?phone=918269520743&text&type=phone_number&app_absent=0";

export default function WhatsAppButton() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-center">
      {/* Pulse ring */}
      <span className="absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-30 animate-pulse-ring" />
      ...
      <a
        ...
        className="relative w-14 h-14 rounded-full bg-green-500 hover:bg-green-400 active:scale-95 flex items-center justify-center shadow-lg shadow-green-900/40 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/30 hover:scale-110"
      >
        {/* WhatsApp SVG icon */}
        <svg
